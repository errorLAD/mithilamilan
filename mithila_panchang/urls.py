...
urlpatterns = [
    ...
    path('masik-mithila-panchang/', views.monthly_calendar, name='masik_mithila_panchang'),
    path('masik-mithila-panchang/<int:year>/<int:month>/', views.monthly_calendar, name='masik_mithila_panchang_specified'),
